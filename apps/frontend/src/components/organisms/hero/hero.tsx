...
export function Hero({ header, body, cta }: HeroProps) {
  return (
    <div className="crt-effect relative text-center max-w-2xl mx-auto px-8 py-10 bg-ctp-surface0/80 backdrop-blur-md rounded-lg border border-ctp-surface2 shadow-2xl animate-terminal-glow">
