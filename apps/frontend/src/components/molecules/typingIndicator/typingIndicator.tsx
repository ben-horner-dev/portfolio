...
export function TypingIndicator({ message }: { message: ChatMessage }) {
  return (
    <>
      {!message.content && (
        <div className="flex justify-start mb-4">
          <div className="bg-primary/20 backdrop-blur-sm rounded-2xl px-4 py-3 max-w-xs border-primary/30 animate-terminal-glow">
